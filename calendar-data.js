const themeData = {
  advent: {
    emojis: ['🎄', '🎅', '🎁', '⛄', '🦌', '🔔', '❄️', '🕯️', '🎨', '🍪'],
    description:
      'Welcome to the magical Advent Calendar! Count down the days until Christmas with festive surprises and holiday cheer. Each day brings you closer to the most wonderful time of the year! 🎄✨',
  },
  winter: {
    emojis: ['❄️', '⛄', '🏂', '🎿', '🧊', '🧣', '🧤', '☃️', '🏔️', '🌨️'],
    description:
      'Embrace the winter wonderland! ❄️ Experience the beauty of snowy days, cozy moments, and winter adventures. Bundle up and enjoy the magical frost-filled journey! ⛄',
  },
  space: {
    emojis: ['🚀', '🛸', '🌎', '🌙', '⭐', '👨‍🚀', '🌠', '🪐', '☄️', '🌌'],
    description:
      'Blast off into the cosmic adventure! 🚀 Explore the mysteries of the universe, discover distant planets, and journey through the stars. Your space odyssey awaits! 🌌',
  },
  ocean: {
    emojis: ['🌊', '🐋', '🐬', '🐠', '🦈', '🐚', '🏊‍♂️', '🏖️', '🐡', '🦀'],
    description:
      'Dive into an oceanic journey! 🌊 Explore the depths of the sea, meet fascinating marine creatures, and discover the wonders beneath the waves. Let the adventure flow! 🐋',
  },
};
